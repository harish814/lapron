...
class TabOurServices extends StatelessWidget {
  const TabOurServices({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return LayoutBuilder(builder: (context,constraints){
      if(constraints.maxWidth > 450 && constraints.maxWidth<800){
        return Container(
          child: Column(
            children: <Widget>[
              SizedBox(
                    ...
                    children: [
                      Container(
                        ...
                        child: Column(
                          children: [
                            Container(
                              width: constraints.maxWidth * 0.88125,
                              child: Column(
